        ...
        switch(arg){
            ...
            case 'update-available':
                ...
                if(process.platform === 'darwin'){
                    info.darwindownload = `https://github.com/nolway/GuildHorizon-Launcher/releases/download/v${info.version}/ghlauncher-setup-${info.version}.dmg`
                    showUpdateUI(info)
                }
...
function showUpdateUI(info){
    ...
    document.getElementById('image_update_container').setAttribute('update', true)
    document.getElementById('image_update_container').onclick = () => {
